## This file is a general .xdc for the Eclypse Z7 Rev. A.0
...
# RGB LEDs
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports {rgbled[0]}]
...
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports {rgbled[3]}]
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33} [get_ports {rgbled[4]}]
set_property -dict {PACKAGE_PIN A19 IOSTANDARD LVCMOS33} [get_ports {rgbled[5]}]
